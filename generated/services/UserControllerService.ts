...
export class UserControllerService {
     ...
     * @throws ApiError
     */
    public static insertwxyUsingGet(): CancelablePromise<string> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/insertwxy',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
     ...
     * @throws ApiError
     */
    public static updatewxyUsingGet(): CancelablePromise<string> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/updatewxy',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
